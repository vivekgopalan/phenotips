...
public class DefaultPatientResourceImplTest
{
    ...
    public void getPatientRejectsRequestWhenUserDoesNotHaveAccess()
    {
        ...
        verify(this.logger).debug("View access denied to user [{}] on patient record [{}]", this.currentUser, PATIENT_ID);
    ...
    public void updatePatientIgnoresMissingPatient()
    {
        ...
        try {
            this.patientResource.updatePatient("", PATIENT_ID);
    ...
    public void updatePatientRejectsRequestWhenUserDoesNotHaveAccess()
    {
        ...
        verify(this.logger).debug("Edit access denied to user [{}] on patient record [{}]", this.currentUser, PATIENT_ID);
    }
    ...
    public void updatePatientThrowsExceptionWhenSentWrongIdInJSON()
    {
        ...
        WebApplicationException ex = null;
        try {
            this.patientResource.updatePatient(json.toString(), PATIENT_ID);
        } catch (WebApplicationException temp) {
            ex = temp;
        }
    ...
    public void updatePatientNormalBehaviour()
    {
        ...
        Response response = this.patientResource.updatePatient(json.toString(), PATIENT_ID);
